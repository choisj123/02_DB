...
VALUES('900', '장채현', '901230-2345678', 'jang_ch@kh.or.kr',  '01055569512', 'D1', 'J8', 'S3', 
           4300000, 0.2, '200', SYSDATE, NULL, 'N');
  
          
INSERT INTO EMPLOYEE2 
VALUES('500', '최수진', '980610-2011817', 'hohosuu@naver.com', '01099164658', 'D3', 'J5', 'S2', 
		5500000, 1.0,'200', SYSDATE, NULL, 'N' );

SELECT * FROM EMPLOYEE2
WHERE EMP_ID = 900; --DML 장채현이 추가 되었음
...
WHERE EMP_ID = 900; -- DML


COMMIT; -- TCL 한번 커밋하면 ROLLBACK 불가
 


------------------------------------------------------------
-- 2) INSERT INTO 테이블명(컬럼명, 컬럼명, 컬럼명) VALUES(데이터1, 데이터2, 데이터3 ....);
-- 테이블에 내가 선택한 컬럼에 대한 값만 INSERT 할 떄 사용
-- 선택 안된 컬럼은 값이 NULL이 들어감 (DEFAULT 존재할 시 DEFAULT로 설정한 값으로 삽입됨)

INSERT INTO EMPLOYEE2(EMP_ID, EMP_NAME, EMP_NO, EMAIL, PHONE, DEPT_CODE, JOB_CODE, SAL_LEVEL, SALARY) 
VALUES('555', '문하준', '901123-2345678', 'jang_ch@kh.or.kr', '01023456321', 'D1', 'J7', 'S3', 4300000);

INSERT INTO EMPLOYEE2(EMP_ID, EMP_NAME, EMP_NO, DEPT_CODE, JOB_CODE, SAL_LEVEL ,SALARY, HIRE_DATE)
VALUES('600', '문기혁', '971003-1111111', 'D3', 'J7', 'S3',4500000, SYSDATE);
...
SELECT EMP_NAME, DEPT_TITLE , JOB_NAME, SALARY, NATIONAL_CODE
FROM EMPLOYEE2
JOIN DEPARTMENT ON(DEPT_CODE = DEPT_ID)
JOIN JOB USING(JOB_CODE)
JOIN LOCATION ON(LOCATION_ID = LOCAL_CODE)
WHERE EMP_NAME IN ('최수진', '문기혁');
...
SELECT *
FROM DEPARTMENT2
WHERE DEPT_ID = 'D9'; -- D9 전략기획팀으로 수정됨
...
--WHERE절 없이 UPDATE 실행으로 모든 행의 컬럼값 변경
UPDATE DEPARTMENT2 
...
FROM EMPLOYEE2 e 
WHERE EMP_NAME IN ('유재식', '방명수'); -- 3400000 / 0.2
...
UPDATE EMPLOYEE2 
SET EMAIL = 'ansrlgur12@gmail.com',
PHONE = '01046209628'
WHERE EMP_NAME = '문기혁';
------------------------------------------------------------------
